                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('category#update',$category->id)}}" method="post" novalidate="novalidate">
                            ...
                            <div class="form-group">
                                ...
                                <input id="cc-pament" name="category" type="text" value="{{old('category',$category->name)}}" class="form-control" aria-required="true" aria-invalid="false" placeholder="Seafood...">
                                @error('category')
